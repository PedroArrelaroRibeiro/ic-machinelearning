...
# ==============================ROTA FIXA
      ...
      Pacote_TX[16] = 0 # tipo de pacote. O número 3 leva informações de RSSI dos dois saltos
      Pacote_TX[17] = 1 # número de saltos no caso 1
...
# nenhuma informação
   ...
   # ============= Camada Física - Recebe o pacote
      ...
      try:
         ...
         print('Pacote_RX[18]:', Pacote_RX[18])
         print('Pacote_RX:', Pacote_RX)
      except:
         pass
